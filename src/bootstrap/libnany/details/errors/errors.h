...
namespace Logs
{
	...
	typedef void (*CallbackMetadata)(void*, Logs::Level, const AST::Node*, Yuni::String& filename, uint32_t& line, uint32_t& offset);


	struct Handler final
	{
	private:
		struct State { void* userdefined; Callback callback; };
	...
	{
	private:
		struct State { void* userdefined; CallbackMetadata callback; };
