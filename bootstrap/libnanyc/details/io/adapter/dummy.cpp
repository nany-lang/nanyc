...
nyio_type_t nanyc_io_fallback_stat(nyio_adapter_t*, const char*, uint32_t) {
	return nyiot_failed;
}

nyio_type_t nanyc_io_fallback_statex(nyio_adapter_t*, const char*, uint32_t, uint64_t* size,
		int64_t* modified) {
	assert(modified);
	assert(size);
	*modified = 0;
...
uint64_t nanyc_io_fallback_file_read(void*, void*, uint64_t) {
	return 0;
}

uint64_t nanyc_io_fallback_file_write(void*, const void*, uint64_t) {
	return 0;
}

void* nanyc_io_fallback_file_open(nyio_adapter_t*, const char*, uint32_t,
		nybool_t, nybool_t, nybool_t, nybool_t) {
	return nullptr;
}

void nanyc_io_fallback_file_close(void*) {
}

nybool_t nanyc_io_fallback_file_eof(void*) {
	return nytrue;
}

nyio_err_t nanyc_io_fallback_file_seek(void*, int64_t) {
	return nyioe_failed;
}

nyio_err_t nanyc_io_fallback_file_seek_set(void*, uint64_t) {
	return nyioe_failed;
}

uint64_t nanyc_io_fallback_file_tell(void*) {
	return 0;
}

void nanyc_io_fallback_file_flush(void*) {
}

uint64_t nanyc_io_fallback_file_size(nyio_adapter_t*, const char*, uint32_t) {
	return 0;
}

nyio_err_t nanyc_io_fallback_file_resize(nyio_adapter_t*, const char*, uint32_t, uint64_t) {
	return nyioe_access;
}

nyio_err_t nanyc_io_fallback_file_erase(nyio_adapter_t*, const char*, uint32_t) {
	return nyioe_access;
}

nyio_err_t nanyc_io_fallback_file_get_contents(nyio_adapter_t*, char** content, uint64_t* size,
...
uint64_t nanyc_io_fallback_folder_size(nyio_adapter_t*, const char*, uint32_t) {
	return 0; // FIXME get folder size
}

nyio_err_t nanyc_io_fallback_folder_create(nyio_adapter_t*, const char*, uint32_t) {
	return nyioe_access;
}

nyio_err_t nanyc_io_fallback_folder_erase(nyio_adapter_t*, const char*, uint32_t) {
	return nyioe_access;
}

nyio_err_t nanyc_io_fallback_folder_exists(nyio_adapter_t*, const char*, uint32_t) {
	return nyioe_access;
}

nyio_err_t nanyc_io_fallback_folder_clear(nyio_adapter_t*, const char*, uint32_t) {
	return nyioe_access;
}

nyio_iterator_t* nanyc_io_fallback_folder_iterate(nyio_adapter_t*, const char* path, uint32_t len,
		nybool_t recursive, nybool_t files, nybool_t folders) {
	return nullptr;
}

nyio_iterator_t* nanyc_io_fallback_folder_next(nyio_iterator_t*) {
	return nullptr;
}

const char* nanyc_io_fallback_folder_iterator_fullpath(nyio_adapter_t*, nyio_iterator_t*) {
	return nullptr;
}

const char* nanyc_io_fallback_folder_iterator_name(nyio_iterator_t*) {
	return nullptr;
}

uint64_t nanyc_io_fallback_folder_iterator_size(nyio_iterator_t*) {
	return 0;
}

nyio_type_t nanyc_io_fallback_folder_iterator_type(nyio_iterator_t*) {
	return nyiot_failed;
}

void nanyc_io_fallback_folder_iterator_close(nyio_iterator_t*) {
}

nyio_err_t nanyc_io_fallback_file_exists(nyio_adapter_t*, const char*, uint32_t) {
	return nyioe_access;
}
