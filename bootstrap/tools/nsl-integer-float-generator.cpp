...
void craftClassInt(Clob& o, uint32_t bits, bool issigned, const AnyString& filename) {
	setFileHeader(o);
	char c = (issigned) ? 'i' : 'u';
	ShortString16 suffix;
	suffix << c << bits;
...
void craftUnittestsCast(Clob& o, AnyString filename) {
	setFileHeader(o);
...
void craftUnittestsModulo(Clob& o, AnyString filename) {
	setFileHeader(o);
